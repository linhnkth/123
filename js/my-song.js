...
xhr.onreadystatechange = function () {
    if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        for (var i = 0; i < arraySongs.length; i++) {
            ...
            htmlContent += '</div>';
            htmlContent += '<div class="song-control" onclick="playSong(\'' + song.link + '\')"><i class="fas fa-play"></i></div>';
            htmlContent += '<div class="song-control"><a href="#"><i class="fas fa-info-circle"></i></div>';
            htmlContent += '</div>';
        }
